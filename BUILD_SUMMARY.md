...
- ✅ **Boss 多阶段系统**：4 个 Boss（熔岩巨像 / 暗影行者 / 深渊领者 / 熔心君主）接入关卡波次末尾，随血线触发加速与召唤
...
### 已完成（v0.3.0）
- ✅ 完整的游戏框架（塔防核心玩法循环）
- ✅ 5 个示例关卡 + 每关末尾 Boss（序章 / 第一章 / 第二章 / 第三章·熔火之心 / 终章·熔心王座）
...
### 尚未实现（后续方向）
- 🔄 背景音乐（BGM）：音频钩子已接入（`bgm_menu`/`bgm_level` 占位条目待音乐文件）
- ✅ 更多关卡：第 4 关（第三章·熔火之心）已实装；第 5 关（终章·熔心王座 + 终局 Boss 熔心君主）已实装

...
**状态**: ✅ **v0.3.0 完成（玩法 / 技能 / Boss / 特效 / 音效齐全）**；✅ **v0.4.0 进行中（界面与世界观 UI 改版已完成，新关卡 level_04 已实装，BGM 钩子已接入待资产）**
...
- ✅ **已实装**：v0.4.0 的「新关卡 level_04（终章·熔火之心）」（第 5 关待做）；导出构建（`build/`）已重新导出（v0.4.0 UI 改版）
...
|------|------|
| 场景文件 (.tscn) | 15 个 |
| 资源配置 (.tres) | 26 个（含 6 分支塔 / 3 Boss / 4 关） |
| 脚本文件 (.gd) | 27 个 |
...
- [x] **更多关卡**：level_04（终章·熔火之心）已基于现有框架实装；第 5 关可继续复制 level_*.tres
